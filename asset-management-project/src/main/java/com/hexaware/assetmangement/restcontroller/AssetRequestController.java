...
import com.hexaware.assetmangement.exception.AssetRequestNotFoundException;
import com.hexaware.assetmangement.service.IAssetRequest;
...
public class AssetRequestController {
    ...
    @PostMapping("/add")
    public ResponseEntity<Object> addAssets(@RequestBody AssetRequest asset) {
        try {
    ...
    public ResponseEntity<Object> searchAllRequests() {
        try {
            List<AssetRequest> assetRequests = service.seacrhAllRequests();
