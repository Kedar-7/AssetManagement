...
public class AssetRequestImp implements IAssetRequest {
	...
	private Logger logger = LoggerFactory.getLogger(AssetRequestImp.class);
	...
	public boolean isValidStatus(Asset asset) {
		if(asset.getStatus().equals("Pending") || asset.getStatus().equals("Approved")) {
			return true;
		}
		return false;
	}
